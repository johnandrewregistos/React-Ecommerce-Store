  ...
  return (
    <header className="text-gray-600 body-font shadow-md">
      <div className="container mx-auto relative flex flex-wrap p-5 flex-row justify-between items-center">
        ...
        <button className="hidden md:flex items-center bg-red-500 border-0 py-1 px-3 focus:outline-none hover:bg-red-600 rounded text-base text-white ">Cart
...

        {
          menu === true ?
            <div className="w-[200px] h-screen flex flex-col items-center bg-white/50 absolute top-0 right-0 px-2 duration-300 transition-all">
              ...
              <button className="flex items-center bg-red-500 border-0 py-1 px-3 focus:outline-none hover:bg-red-600 rounded text-base text-white ">Cart
                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-1" viewBox="0 0 24 24">
                  <path d="M5 12h14M12 5l7 7-7 7"></path>
                </svg>
              </button>
