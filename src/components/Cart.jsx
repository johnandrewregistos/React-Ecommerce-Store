...
const Cart = () => {
  ...
  if (!cart.length) {
    return (
      <div className='w-full h-[50vh] flex justify-center items-center text-2xl font-medium'>Cart is Empty</div>
    )
  }
    ...
    <div className="container mx-auto mt-10">
      <div className="flex flex-col md:flex-row shadow-md my-10">
        <div className="w-3/4 bg-white px-10 py-10">
                ...
                <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                  <div className="flex w-2/5">
                    ...
                    <div className="flex flex-col justify-between ml-4 flex-grow">
                      ...
                      <div className="font-semibold text-red-500 hover:text-red-600 text-lg cursor-pointer" onClick={() => removeItem(item?.id)}><BsFillTrashFill /></div>
                    </div>
                  </div>
          ...
          <Link to={'/products/'} className="flex font-semibold text-red-600 text-sm mt-10">
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <button className="bg-indigo-500 hover:bg-indigo-600 px-5 py-2 text-sm text-white uppercase">Apply</button>
